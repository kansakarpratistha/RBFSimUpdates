...
#----------------------------------------------------------------------Create_Well----------------------------------------------------------------------------------------                   
        if choice_well == "New Data":
            ...
            with col1:
                ...
                pump_rate = st.number_input("Pumping / Recharge Rate in (m³/day):", -10000., 300., 30., 1.,help='-ve Pumping, +ve Recharge')
            ...
            if len(st.session_state.we_ls)!= 0 :
                ...
                if selected_result:
                    ...
                    with col1:
                        ...
                        #----------limit pump_rate input upto 50 for 2D and 3D plot runtime error-----------------
                        new_pump_rate = st.number_input("Pumping / Recharge Rate in (m\u00B3/day):", -10000., 300., float(pump_rate),help='-ve Pumping, +ve Recharge')
                        # st.warning('Please keep the Pumping Rate < 50 to generate 3D plot.', icon="⚠️")
                    with col2:
